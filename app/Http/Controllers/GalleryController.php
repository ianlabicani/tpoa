...
class GalleryController extends Controller
{
    public function show($id)
    {
        $images = [
            ...
            2 => ['src' => 'image/history/boat-unloading.jpg', 'title' => 'Fishing Boat Unloading -CA. 1900s-1930s', 'description' => 'This photograph captures the bustling activity of a fishing boat unloading its catch in Aparri, a prominent coastal town in Cagayan Province in northern Luzon. Taken during the early 20th century, the image reflects the vital role of the fishing industry in the livelihood of the local population.
