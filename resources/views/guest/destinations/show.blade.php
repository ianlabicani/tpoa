    ...
    @forelse ($feedbacks as $feedback)
        <div class="card mb-3 p-3">
            ...
            <div class="d-flex justify-content-start">
                <span class="mr-3">
                    <i class="fas fa-thumbs-up"></i> <strong>{{ $feedback->reactions->where('reaction', 'like')->count() }}</strong>
                </span>
                <span>
                    <i class="fas fa-thumbs-down"></i> <strong>{{ $feedback->reactions->where('reaction', 'dislike')->count() }}</strong>
                </span>
            </div>
        </div>
    @empty
