...
<div class="container mt-5">
    ...
    <!-- Search Bar -->
    <form method="GET" action="{{ route('user.destinations.index') }}" class="mb-4">
        <div class="search-box">
            <button type="submit" class="btn-search"><i class="fas fa-search"></i></button>
            <input type="text" class="input-search" name="search" placeholder="Type to Search..." value="{{ request()->search }}">
        </div>
    </form>
                    ...
                    <div class="card w-100">
                        ...
                        @if ($destination->day_images && count(json_decode($destination->day_images, true)) > 0)
                            ...
                            <div class="destination-container">
                                <a href="{{ route('user.destinations.show', $destination->id) }}" class="btn-learn-more">
