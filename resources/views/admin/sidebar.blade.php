<nav class="bg-dark text-white p-4">
    ...
    <a class="btn btn-primary d-block mb-2" href="{{ route('admin.videos.index') }}" role="button">Videos</a>
    <a class="btn btn-primary d-block mb-2" href="{{ route('admin.destinations.create') }}" role="button">Add
        Destination</a>
    <a class="btn btn-primary d-block mb-2" href="{{ route('admin.destinations.index') }}"
